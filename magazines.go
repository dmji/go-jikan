...
func newMagazines(sdkConfig sdkConfiguration) *Magazines {
	return &Magazines{
		sdkConfiguration: sdkConfig,
	}
}

func (s *Magazines) Get(ctx context.Context, request operations.GetMagazinesRequest, opts ...operations.Option) (*operations.GetMagazinesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/magazines")
	if err != nil {
	...
	res := &operations.GetMagazinesResponse{
