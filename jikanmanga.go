...
func newJikanManga(sdkConfig sdkConfiguration) *JikanManga {
	return &JikanManga{
		sdkConfiguration: sdkConfig,
	}
}

func (s *JikanManga) Get(ctx context.Context, filter *components.GenreQueryFilter, opts ...operations.Option) (*operations.GetMangaGenresResponse, error) {
	request := operations.GetMangaGenresRequest{
		Filter: filter,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/genres/manga")
	if err != nil {
	...
	res := &operations.GetMangaGenresResponse{
