...
func (s *Schedules) Get(ctx context.Context, request operations.GetSchedulesRequest, opts ...operations.Option) (*operations.GetSchedulesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/schedules")
	if err != nil {
