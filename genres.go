...
func newGenres(sdkConfig sdkConfiguration) *Genres {
	return &Genres{
		...
		Manga:            newJikanManga(sdkConfig),
	}
}

func (s *Genres) GetAnime(ctx context.Context, filter *components.GenreQueryFilter, opts ...operations.Option) (*operations.GetAnimeGenresResponse, error) {
	request := operations.GetAnimeGenresRequest{
		Filter: filter,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/genres/anime")
	if err != nil {
	...
	res := &operations.GetAnimeGenresResponse{
